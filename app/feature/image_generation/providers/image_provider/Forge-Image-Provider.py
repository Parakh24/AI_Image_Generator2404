...
class ForgeImageProvider(ImageProvider):
    """Generate images by calling a local Stable Diffusion Forge API."""

    def __init__(self):
        """Load the Forge server address and request timeout from the environment."""
    ...
    def generate_image(
        ...
        """Request one image from Forge and return its decoded bytes and metadata."""
