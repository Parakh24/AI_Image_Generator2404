...
class GenerationJobRepository: 
    ...
    def create_job(
        ...
        job = GenerationJob(
            ...
            tenant_id=tenant_id,  #  Mapped tenant_id to model field
            prompt=prompt,
    ...
    def get_job_by_id_and_tenant(self, job_id: str, tenant_id: str) -> Optional[GenerationJob]:
        """
        Return the job matching both ID and tenant_id.
        Prevents tenant A from accessing jobs belonging to tenant B.
        """
        return (
    ...
    def update_job_status(
        ...
        job = self.get_job_by_id(job_id)  # Fixed typo: 'get_job_bby_id' -> 'get_job_by_id'
